...
export function DepartmentNode({
  ...
  return (
    <button
      onClick={onToggle}
      className={cn(
        'group flex w-full min-w-[200px] max-w-[240px] flex-col gap-2 rounded-xl border p-4 text-left',
    ...
    >
      <div className="flex items-start justify-between gap-2">
        ...
        <div className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-white/15 transition-transform duration-200">
          {expanded ? (
